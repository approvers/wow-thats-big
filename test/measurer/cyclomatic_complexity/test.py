...
class FileSizeMeasurerTest(unittest.TestCase):
    ...
    def test_not_big(self):
        ...
        result = measurer.measure("testcase/not_big.py", Argument(directory="", min_file_size_kb=512, min_line=-1))
        self.assertIsNone(result)

    def test_big(self):
        measurer = FileSizeMeasurer()
        result = measurer.measure("testcase/musical_typer_main.py", Argument(directory="", min_file_size_kb=512, min_line=-1))
